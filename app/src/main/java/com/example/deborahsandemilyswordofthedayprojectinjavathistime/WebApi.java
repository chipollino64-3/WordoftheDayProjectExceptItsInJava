...
public final class WebApi {
    ...
    static final String API_BASE = "https://xkubist-random-word-v1.p.rapidapi.com/run.cgi";

    /** The URL at which the webserver socket is hosted. */
    static final String WEBSOCKET_BASE = "wss://xkubist-random-word-v1.p.rapidapi.com/run.cgi";
